  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="sanskar.png" alt="Sanskar Gundecha" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/sanskar-gundecha-7333b9231"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by ⭐ Sanskar Gundecha</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
